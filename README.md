...
- [x] Server: in MessagesController, implement a `def create(data)` method that create a message from `data['message']` and broadcast the message rendering to the `chat` stream.
